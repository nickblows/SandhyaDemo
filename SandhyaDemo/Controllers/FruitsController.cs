...
namespace SandhyaDemo.Controllers
{
    public class FruitsController : Controller
    {
        ...
        {
            return _context.Fruit != null ?
                          View(await _context.Fruit.ToListAsync()) :
                          Problem("Entity set 'FruitContext.Fruit'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type")] Fruit fruit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type")] Fruit fruit)
        {
            if (id != fruit.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FruitContext.Fruit'  is null.");
            }
            var fruit = await _context.Fruit.FindAsync(id);
            if (fruit != null)
            {
